...
- [ ] phase-13 가 Toolbar 의 captureBlob 헬퍼 → 정식 export 헬퍼로 _교체_ 가능 (다른 Toolbar 슬롯 수정 없음)
- [ ] phase-14 가 stagger fade-in / 카테고리 트리 / 사이드패널 폭 px 정확 등 _후속_ 만 도입
- [ ] phase-15 가 a11y axe + CVD 모드 팔레트 + i18n 한·영 폴리싱 _추가_ 만
